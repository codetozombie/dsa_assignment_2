...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                switch (choice) {
                    case 1:
                        handleMaxElement(scanner);
                        break;
                    case 2:
                        handleUniqueElements(scanner);
                        break;
                    case 3:
                        handleMatrixMultiplication(scanner);
                        break;
                    case 4:
                        handleGaussianElimination(scanner);
                        break;
                    case 5:
                        handleBinaryCount(scanner);
                        break;
                    case 6:
    ...
    private static void handleMaxElement(Scanner scanner) {
    ...
    private static void handleUniqueElements(Scanner scanner) {
        System.out.println("Enter the number of elements:");
    ...
    private static void handleGaussianElimination(Scanner scanner) {
    ...
    private static void handleBinaryCount(Scanner scanner) {
    ...
    private static void handleTowerOfHanoi(Scanner scanner) {
    ...
    private static void handleFibonacci(Scanner scanner) {
